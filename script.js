...
const movieAll = await Promise.all([downloadMovie1, downloadMovie2, downloadMovie3])
...
async function downloadRase(){
    const movieRace = await Promise.race([downloadMovie1(), downloadMovie2(), downloadMovie3()])
